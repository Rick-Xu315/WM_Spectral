"""KnOTS-TIES merge of (WMRL, PRL-from-base) on Qwen2.5-7B-Instruct.

Paper experiment: training-free world-model preservation merges over (M_WMRL, M_PRL).
...
POLICY_RL_PATH = f"{CKPT_ROOT}/alfworld/prl"
